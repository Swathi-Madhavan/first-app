import { ListOfProjectsProps, ProjectProps } from "../model";
import ProjectInfo from "./ProjectInfo";

export function ListOfProjects({ bigBox, topic, techIcons, isFirstItem }: ListOfProjectsProps) {
  return (
    <>
    <div className="row-align" style={{
